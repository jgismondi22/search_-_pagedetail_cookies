            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ClipPath(
                  ...
                  child: Container(color: kBestSellerColor,
                ...
                SizedBox(height:16),
                Row(children: <Widget>[SvgPicture.asset('assets/icons/person.svg'),
                  SizedBox(width: 5),
                  Text('18k'),
                  SizedBox(width: 20),
      ...
      child: Row(children: <Widget>[
        ...
        RichText(
          ...
          children: [
            ...
            TextSpan(
              text: title,
              style:kSubtitleTextSyle.copyWith(fontWeight: FontWeight.w600,
              height: 1.5,
              ),
            ),
          ],
